...
<body>
	...
	<div class="container">
		...
		<div style="height: auto" class="JumboT jumbotron Transp">
			...
			<form:form id="validacion-live" class="form-horizontal"
				action="searchPostulante" method="post" modelAttribute="postulante">
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-4">
							...
							<div class="input-group">
								<span class="input-group-addon" id="basic-addon1">RUT
									Postulante:</span> <input id="rut" name="rut" type="text"
									class="form-control" placeholder="RUT" aria-label="Username"
					...
					<div class="row">
						...
						<div class="col-md-4">
							<button type="submit" class="btn btn-primary btn-lg"
								data-toggle="modal">Buscar Postulante »</button>
						</div>
						<div class="col-md-4"></div>
					</div>
				</div>
