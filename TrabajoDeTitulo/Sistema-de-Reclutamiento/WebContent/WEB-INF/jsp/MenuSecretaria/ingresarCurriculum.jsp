...
<!--                     <br> -->
                    <div class="row">
                        ...
                        <div class="col-md-4">
                                <div class="input-group">
                                    ...
                                    <input disabled id="contraseña" name="contraseña" type="text" class="form-control" placeholder="contraseña" aria-label="contraseña" aria-describedby="basic-addon1" required>
                                </div>
                        </div>
                        <div class="col-md-4"></div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4"></div>
                        <div class="col-md-4">
                            <button type="submit" class="btn btn-primary btn-lg">Guardar Curriculum »</button>
                        </div>
                        <div class="col-md-4"></div>
                    </div>
                </div>
