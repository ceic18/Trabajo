...
<head>
    ...
    <link href="<s:url value="/resources/css/smart_wizard.css"/>" rel="stylesheet" type="text/css" />
    
    <!-- Optional SmartWizard theme -->
    <link href="<s:url value="/resources/css/smart_wizard_theme_dots.css"/>" rel="stylesheet" type="text/css" />
</head>
<body>
    <div class="container">
        <br />
    ...
    <script type="text/javascript" src="<c:url value="/resources/js/jquery.smartWizard.min.js"/>"></script>
